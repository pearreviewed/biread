...
_ENGLISH_UI = {
    ...
    "glossAdd": "Add glosses",
    "glossKeepingUp": "Glossing as you read",
    "glossKeyBody": "This page is glossed first, then the rest of the book while you read it. Stop it whenever you like.",
    "glossAdding": "Adding glosses…",
    "glossKeyTitle": "Your key, your glosses",
    "glossFailed": "That page would not gloss. Try it again.",
...
_SPANISH_UI = {
    ...
    "glossAdd": "Añadir glosas",
    "glossKeepingUp": "Glosando mientras lees",
    "glossKeyBody": "Esta página se glosa primero, y el resto del libro mientras lo lees. Puedes detenerlo cuando quieras.",
    "glossAdding": "Añadiendo glosas…",
    "glossKeyTitle": "Tu clave, tus glosas",
    "glossFailed": "Esta página no se pudo glosar. Inténtalo de nuevo.",
...
_ITALIAN_UI = {
    ...
    "glossAdd": "Aggiungi glosse",
    "glossKeepingUp": "Glossa mentre leggi",
    "glossKeyBody": "Prima questa pagina, poi il resto del libro mentre lo leggi. Puoi fermarlo quando vuoi.",
    "glossAdding": "Aggiunta delle glosse…",
    "glossKeyTitle": "La tua chiave, le tue glosse",
    "glossFailed": "Questa pagina non si è potuta glossare. Riprova.",
...
_GERMAN_UI = {
    ...
    "glossAdd": "Glossen hinzufügen",
    "glossKeepingUp": "Glossiert beim Lesen",
    "glossKeyBody": "Zuerst diese Seite, dann der Rest des Buches, während du liest. Du kannst jederzeit aufhören.",
    "glossAdding": "Glossen werden hinzugefügt…",
    "glossKeyTitle": "Dein Schlüssel, deine Glossen",
    "glossFailed": "Diese Seite ließ sich nicht glossieren. Versuch es noch einmal.",
...
_PORTUGUESE_UI = {
    ...
    "glossAdd": "Adicionar glosas",
    "glossKeepingUp": "A glosar enquanto lês",
    "glossKeyBody": "Primeiro esta página, depois o resto do livro enquanto o lês. Podes parar quando quiseres.",
    "glossAdding": "A adicionar glosas…",
    "glossKeyTitle": "A tua chave, as tuas glosas",
    "glossFailed": "Esta página não se conseguiu glosar. Tenta de novo.",
